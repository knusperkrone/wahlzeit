...
public class PhotoUtil {
	 ...
	 * 
	 */
	public static Photo createPhoto(PhotoFactory<?> factory, File source, PhotoId id, LocationId locationId) throws Exception {
		Photo result = factory.createPhoto(id, locationId);
